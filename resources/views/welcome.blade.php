...
@section('content')
<!-- Hero Section -->
<section class="relative overflow-hidden pt-14 pb-20 lg:pt-24 lg:pb-28 bg-gradient-to-b from-emerald-50/70 via-white to-slate-50">
    <!-- Ambient background glow -->
    <div class="absolute -top-28 left-1/2 -translate-x-1/2 w-[650px] h-[350px] bg-gradient-to-tr from-emerald-400/15 via-teal-300/20 to-emerald-200/15 blur-3xl rounded-full pointer-events-none -z-0"></div>

    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="text-center max-w-3xl mx-auto">
            <div class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-emerald-100/80 border border-emerald-200 text-emerald-800 text-xs font-bold tracking-wide uppercase mb-6 shadow-xs backdrop-blur-sm">
                <i data-lucide="sparkles" class="w-3.5 h-3.5 text-emerald-600"></i>
                <span>Didukung oleh Petani Lokal Terverifikasi</span>
            </div>
            ...
            <h1 class="text-4xl sm:text-5xl lg:text-6xl font-black text-slate-900 tracking-tight leading-[1.15] mb-6">
                ...
                <span class="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 via-emerald-500 to-teal-600">Memperluas Akses Pasar.</span>
            </h1>

            <p class="text-base sm:text-lg text-slate-600 mb-8 max-w-2xl mx-auto leading-relaxed font-normal">
            ...
            <div class="flex items-center justify-center">
                <a href="{{ route('register') }}" class="inline-flex items-center justify-center gap-2.5 px-8 py-4 rounded-2xl bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-base shadow-lg shadow-emerald-600/25 hover:shadow-xl hover:shadow-emerald-600/30 hover:-translate-y-0.5 transition duration-200">
            ...
            <!-- Role Badge Pillows -->
            <div class="mt-12 pt-8 border-t border-slate-200/80 flex flex-wrap items-center justify-center gap-3 sm:gap-6 text-xs font-semibold text-slate-600">
                <div class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white border border-slate-200 shadow-xs">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="p-8 sm:p-10 rounded-3xl bg-emerald-50/50 border border-emerald-100 relative overflow-hidden">
                ...
                <ul class="space-y-3.5 text-sm text-slate-600">
                    ...
                    <li class="flex items-start gap-3">
                        <i data-lucide="check-circle" class="w-5 h-5 text-emerald-600 flex-shrink-0 mt-0.5"></i>
                        <span><strong>Alur Panen &rarr; Stok &rarr; Pasar:</strong> Jaminan data stok riil yang tidak pernah negatif dan terverifikasi kepemilikannya.</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <i data-lucide="check-circle" class="w-5 h-5 text-emerald-600 flex-shrink-0 mt-0.5"></i>
...
<section id="komoditas" class="py-20 bg-slate-50 border-t border-slate-200/80">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col md:flex-row md:items-end justify-between mb-12">
            ...
            <p class="text-sm text-slate-500 mt-2 md:mt-0">Didukung oleh petani lokal terverifikasi</p>
        </div>
