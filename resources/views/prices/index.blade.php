...
<div class="space-y-8">
    ...
    <div class="bg-gradient-to-r from-emerald-950 via-teal-900 to-slate-900 rounded-3xl p-6 sm:p-8 text-white shadow-lg relative overflow-hidden">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
            ...
            <div class="flex items-center gap-2 text-xs font-semibold text-slate-300 bg-white/10 backdrop-blur-md px-4 py-2.5 rounded-2xl border border-white/10">
                <i data-lucide="info" class="w-4 h-4 text-emerald-400"></i>
                <span>Data historis survei pasar berkala</span>
            </div>
        </div>
    </div>
